...
/**
 * History Component in Light Theme
 */
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 pb-6 mb-8">
        <div>
          <h2 className="text-3xl font-extrabold text-slate-800">Research Database</h2>
        ...
        <div className="relative max-w-sm w-full">
          ...
          <input
            ...
            className="w-full bg-white border border-slate-300 rounded-lg pl-10 pr-4 py-2 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500 transition-colors"
          />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredReports.map((report) => {
            ...
            return (
              <div
                key={report._id}
                className="bg-white hover:bg-slate-50/50 border border-slate-200 rounded-xl p-5 transition-all flex flex-col justify-between shadow-sm hover:shadow-md"
              >
                <div>
                  {/* Card Header */}
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="flex items-center space-x-2">
                          <span className="bg-blue-50 text-blue-600 font-mono font-bold text-[10px] px-2 py-0.5 rounded border border-blue-100">
                            {report.ticker}
                          </span>
                  ...
                  <h4 className="text-slate-800 font-extrabold text-base mb-1">{report.companyName}</h4>
                  <p className="text-xs text-slate-500 line-clamp-2 mb-4">{report.query}</p>
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                  <div className="flex space-x-4 text-[11px] text-slate-500">
                    ...
                    <div>
                      Confidence: <span className="font-bold text-blue-600">{report.confidenceScore}%</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <button
                      ...
                      className="flex items-center space-x-1.5 bg-blue-50 hover:bg-blue-600 text-blue-600 hover:text-white px-3 py-1.5 rounded-lg text-xs font-bold transition-all border border-blue-100 hover:border-blue-600 cursor-pointer"
                    >
